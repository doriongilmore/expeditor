...
(function(){
    ...
    Chart.defaults = {
        global: {
            ...
            tooltipTemplate:"<%if (label){%><%=label%> <%}%><%= value%><%if (unity){%> <%=unity%> <%}%><%if (typeof id != 'undefined'){%><%suligneLegend(id);%><%}%>",
            // String - Template string for single tooltips
...
/*
 * Ajout de la fonction pour generer la lÃƒÂ©gende
 * @By Guillaume
 */
...
function legend(parent, data) {
    ...
    datas.forEach(function(d) {
        ...
        if(d.lien != undefined)
            title.name = d.lien;
        if(d.identifiant != undefined)
            title.id = d.identifiant;
