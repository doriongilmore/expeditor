...
//    if(is_null($this->user->identifiant) && $this->uri->segment(1).'/'.$this->uri->segment(2) != 'connexion/authentification')
//    {
...
//      $this->load->model('simple/m_utilisateur', 'User');
//
//      $user = $this->User->getUnUtilisateur($_SESSION['user_id']);
//
